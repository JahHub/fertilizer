...
use JahHub\FertilizerBundle\RestHandler\WeekHandler;
use Prophecy\Prophecy\ObjectProphecy;
use Symfony\Component\Form\FormInterface;

/**
 * Class WeekWeekHandlerTest
 */
class WeekWeekHandlerTest extends AbstractHandlerTest
{
    ...
    public function setUp()
    {
        ...
        $this->formTypeName = 'fertilizer_week';
