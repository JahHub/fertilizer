...
class ItemQuantityController extends AbstractController
{
     ...
     *   output = "array<JahHub\FertilizerBundle\Entity\ItemQuantity>",
     *   statusCodes = {
     ...
     * @ApiDoc(
     *   resource = true,
     *   output = "JahHub\FertilizerBundle\Entity\ItemQuantity",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     *   input = "JahHub\FertilizerBundle\Entity\ItemQuantity",
     *   statusCodes = {
     *     200 = "Returned when successful",
